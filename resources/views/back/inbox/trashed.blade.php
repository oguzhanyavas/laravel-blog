    ...
    <div class="row">
        <div class="col-md-3">
            <div class="box-body no-padding">
                ...
                <a class="form-control text-primary" href="{{ route('admin.inbox.trashed') }}"><i class="fa fa-trash-o"></i> Çöp Kutusu </a>
            </div>
        </div>
        <!-- /.col -->
        <div class="col-md-9">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <div class="box-body no-padding">
                    <form class="" action="{{ route('admin.refreshMulti') }}" method="post">
                        @csrf
                            ...
                            <table class="table table-hover table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-name"><a class="@if($inbox->status == 0) text-primary @else text-muted @endif">{{ $inbox->name }}</a></td>
                                        <td class="mailbox-subject"><b>{{ $inbox->topic }}</b> - {{ Str::limit($inbox->message,80) }}
                                        </td>
                                        <td class="mailbox-attachment"></td>
                                        <td class="mailbox-date">{{ $inbox->deleted_at->diffForHumans() }}</td>
                                    </tr>
                                    @endforeach
